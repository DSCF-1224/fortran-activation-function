module pkg_activation_function
   ...
   ! <interface>s for this <module>
    ...
    interface der_silu
        ...
        module pure elemental function der_silu_real32 ( x ) result( der_silu )
        ...
        module pure elemental function der_silu_real64 ( x ) result( der_silu )
